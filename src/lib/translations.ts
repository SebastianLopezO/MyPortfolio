    ...
    profile: {
        ...
        services: {
            crm: {
                ...
                item1: {
                    es: "Implementación y personalización avanzada de Zoho CRM",
                    en: "Advanced Zoho CRM implementation and customization"
                },
                item2: {
                    es: "Desarrollo de scripts en Deluge para automatizaciones a medida",
                    en: "Deluge script development for custom automations"
                },
                item3: {
                    es: "Creación de aplicaciones empresariales en Zoho Creator",
                    en: "Enterprise application development in Zoho Creator"
                },
            ...
            backend: {
                ...
                item1: {
                    es: "Desarrollo de APIs RESTful personalizadas (Python/Java)",
                    en: "Custom RESTful API development (Python/Java)"
                },
                item2: {
                    es: "Sincronización de bases de datos externas con CRMs",
                    en: "External database synchronization with CRMs"
                },
                item3: {
                    es: "Integración de WhatsApp API con sistemas de gestión",
                    en: "WhatsApp API integration with management systems"
                },
            },
            bi: {
                title: {es: "Inteligencia de Negocios y Datos", en: "Business Intelligence & Data"},
                item1: {
                    es: "Auditoría y limpieza de bases de datos (Data Quality)",
                    en: "Database audit and cleaning (Data Quality)"
                },
            ...
            infra: {
                ...
                item1: {
                    es: "Configuración y administración de servidores VPS (Linux)",
                    en: "VPS server configuration and administration (Linux)"
                },
                item2: {es: "Despliegue de aplicaciones con Docker", en: "Application deployment with Docker"},
                item3: {
                    es: "Configuración de servidores web seguros (Nginx, SSL)",
                    en: "Secure web server configuration (Nginx, SSL)"
                },
            },
        },
