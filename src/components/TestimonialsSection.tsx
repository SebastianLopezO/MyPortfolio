            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3 pt-3">
                  <span className="inline-block px-2 py-1 text-xs font-mono font-semibold bg-primary/10 text-primary rounded-full border border-primary/30">
                ...
                {/* Quote */}
                <blockquote className="text-muted-foreground text-sm leading-relaxed mb-4 italic flex-grow line-clamp-5">
                  "{testimonial.quote}"
                </blockquote>
