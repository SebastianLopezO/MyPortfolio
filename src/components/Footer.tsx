...
const socialLinks = [
    ...
    {icon: HackerRankIcon, href: "https://www.hackerrank.com/profile/sebastianlopezo1", label: "HackerRank", isCustom: true},
...
const additionalLinks = [
    ...
    {name: "LinkedIn", href: "https://www.linkedin.com/in/sebastianlopezosorno/", color: "bg-blue-600/10 text-blue-400"},
    {name: "HackerRank", href: "https://www.hackerrank.com/profile/sebastianlopezo1", color: "bg-emerald-500/10 text-emerald-400"},
    {name: "FreeCodeCamp", href: "https://www.freecodecamp.org/sebastianlopezo", color: "bg-green-500/10 text-green-400"},
