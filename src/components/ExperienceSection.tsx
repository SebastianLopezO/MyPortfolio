            ...
            >
              ...
              >
                <div className="p-6 rounded-lg bg-card border border-border hover:border-primary/50 transition-all duration-300 glow-hover group">
                  ...
                  {/* Location & Work Type */}
                  <div className={`flex items-center gap-2 text-xs text-muted-foreground mb-3 ${index % 2 === 0 ? "md:justify-end" : ""}`}>
                      ...
                      <ul className={`space-y-2 ${index % 2 === 0 ? "md:text-right" : ""}`}>
                        {(lang === "es" ? exp.highlightsEs : exp.highlights).map((highlight, hIndex) => (
                          <li key={hIndex} className="text-sm text-muted-foreground flex items-start gap-2">
                            <span className={`text-primary mt-1.5 flex-shrink-0 ${index % 2 === 0 ? "md:order-2" : ""}`}>•</span>
                            <span>{highlight}</span>
                          </li>
                        ))}
                      </ul>
