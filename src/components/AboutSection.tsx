                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="animate-fade-in-bounce">
                        <div className="relative">
                            ...
                            <pre
                                className="relative font-mono text-[10px] sm:text-xs md:text-sm text-primary bg-background/80 p-4 md:p-6 rounded-lg border border-border overflow-x-auto whitespace-pre">
                {asciiArt}
              </pre>
                        ...
                        <div className="grid grid-cols-3 gap-4 pt-4">
                            {[
                                ...
                                >
                                    ...
                                    <span
                                        className="text-xs md:text-sm text-muted-foreground text-center">{item.label}</span>
                                    <span
                                        className="text-sm md:text-lg font-semibold text-foreground">{item.value}</span>
                                </div>
                            ))}
                        </div>
                    </div>
